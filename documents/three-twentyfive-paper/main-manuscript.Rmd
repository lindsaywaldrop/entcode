...
three_hair_odor <- read.csv("./results/r-csv-files/3hair_results/totalconc_3hairs_2023-11-02_cleaned.csv", 
                      skip = 0, header = T, row.names = 1)
three_hair_odor <- three_hair_odor[order(three_hair_odor$simulation_number), ]
twofive_hair_odor <- read.csv("./results/r-csv-files/25hair_results/totalconc_25hairs_2023-11-02_cleaned.csv", 
                        skip = 0, header = T, row.names = 1)
...
twofive_hair$total_conc <- twofive_hair$raw_total_conc * (twofive_hair$hair_dxdy * 
                                                            twofive_hair$hair_dots)
