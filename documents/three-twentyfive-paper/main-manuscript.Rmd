...
p3 <- ggplot(three_hair[order(three_hair$norm_conc),], aes(.data[["gap"]], .data[["angle"]], 
    ...
    geom_point() +
  scale_color_viridis_b("Normalized\nconcentration", breaks = seq(0,0.15, by = 0.025), limits = c(0,0.15))+
  scale_size_binned("Normalized\nconcentration", breaks = seq(0,0.15, by = 0.025), range = c(0.5, 4), limits = c(0,0.15)) + 
...
plot_values(three_hair, "angle", "hair") +
