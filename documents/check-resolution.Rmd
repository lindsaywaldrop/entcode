...
sim_468_all <- rbind(sim0468$hair_totals, sim8468$hair_totals)
...
sim_906_all <- rbind(sim0906$hair_totals, sim8906$hair_totals)
...
```{r}
three_hair <- read.csv("./results/r-csv-files/3hair_results/totalconc_3hairs_2024-02-05.csv", 
                      skip = 1, header = T, row.names = 1)
