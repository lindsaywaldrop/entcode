...
alldataair.totalconc <- data.frame(airdata_3[,1:3], airdata_3$total.conc,
                                   airdata_5$total.conc, 
                                   #airdata_7$total.conc,
...
#labelair.df <- data.frame(variable=c("3hairs","5hairs",
                                     #"7hairs",
#                                     "12hairs","18hairs","25hairs"), 
#                          value=c(30000,NA,NA,
#                                  #NA,
#                                  NA,NA))
#labelwater.df <- data.frame(variable=c("3hairs","5hairs",
#                                       #"7hairs",
#                                       "12hairs","18hairs","25hairs"), 
#                            value=c(200,NA,NA,
#                                    #NA,
...
all.water <- ggplot(alldatawaterconc.melted, aes(variable, value, fill = variable)) + 
  ...
  xlab("") + ylab("Total Conc Captured") + ggtitle("Water") + ylim(0, 700) +
...
all.air <- ggplot(alldataairconc.melted, aes(variable, value, fill = variable)) +
  ...
  #           mapping=aes(x=variable,y=value),color="black",pch="*",size=6) +
  xlab("") + ylab("Total Conc Captured") + ggtitle("Air") + ylim(0, 35000) +
  theme_bw() + theme(plot.title = element_text(hjust = 0.5), legend.position = "none")
...
model.water35<-t.test(alldatawater.totalconc$'3hairs',alldatawater.totalconc$'5hairs')
print("Water: 3-hair vs 5-hair")
print(model.water35)
#model.water37<-t.test(alldatawater.totalconc$'3hairs',alldatawater.totalconc$'7hairs')
#print("3-hair vs 7-hair")
#print(model.water37)
model.water312<-t.test(alldatawater.totalconc$'3hairs',alldatawater.totalconc$'12hairs')
print("Water: 3-hair vs 12-hair")
print(model.water312)
model.water318<-t.test(alldatawater.totalconc$'3hairs',alldatawater.totalconc$'18hairs')
print("Water: 3-hair vs 18-hair")
print(model.water318)
model.water325<-t.test(alldatawater.totalconc$'3hairs',alldatawater.totalconc$'25hairs')
print("Water: 3-hair vs 25-hair")
print(model.water325)
model.water512<-t.test(alldatawater.totalconc$'5hairs',alldatawater.totalconc$'12hairs')
print("Water: 5-hair vs 12-hair")
print(model.water512)
model.water518<-t.test(alldatawater.totalconc$'5hairs',alldatawater.totalconc$'18hairs')
print("Water: 5-hair vs 18-hair")
print(model.water518)
model.water525<-t.test(alldatawater.totalconc$'5hairs',alldatawater.totalconc$'25hairs')
print("Water: 5-hair vs 25-hair")
print(model.water525)
model.water1218<-t.test(alldatawater.totalconc$'12hairs',alldatawater.totalconc$'18hairs')
print("Water: 12-hair vs 18-hair")
print(model.water1218)
model.water1225<-t.test(alldatawater.totalconc$'12hairs',alldatawater.totalconc$'25hairs')
print("Water: 12-hair vs 25-hair")
print(model.water1225)
model.water1825<-t.test(alldatawater.totalconc$'18hairs',alldatawater.totalconc$'25hairs')
print("Water: 18-hair vs 25-hair")
print(model.water1825)

model.air35<-t.test(alldataair.totalconc$'3hairs',alldataair.totalconc$'5hairs')
print("Air: 3-hair vs 5-hair")
print(model.air35)
#model.water37<-t.test(alldatawater.totalconc$'3hairs',alldatawater.totalconc$'7hairs')
#print("3-hair vs 7-hair")
#print(model.water37)
model.air312<-t.test(alldataair.totalconc$'3hairs',alldataair.totalconc$'12hairs')
print("Air: 3-hair vs 12-hair")
print(model.air312)
model.air318<-t.test(alldataair.totalconc$'3hairs',alldataair.totalconc$'18hairs')
print("Air: 3-hair vs 18-hair")
print(model.air318)
model.air325<-t.test(alldataair.totalconc$'3hairs',alldataair.totalconc$'25hairs')
print("Air: 3-hair vs 25-hair")
print(model.air325)
model.air512<-t.test(alldataair.totalconc$'5hairs',alldataair.totalconc$'12hairs')
print("Air: 5-hair vs 12-hair")
print(model.air512)
model.air518<-t.test(alldataair.totalconc$'5hairs',alldataair.totalconc$'18hairs')
print("Air: 5-hair vs 18-hair")
print(model.air518)
model.air525<-t.test(alldataair.totalconc$'5hairs',alldataair.totalconc$'25hairs')
print("Air: 5-hair vs 25-hair")
print(model.air525)
model.air1218<-t.test(alldataair.totalconc$'12hairs',alldataair.totalconc$'18hairs')
print("Air: 12-hair vs 18-hair")
print(model.air1218)
model.air1225<-t.test(alldataair.totalconc$'12hairs',alldataair.totalconc$'25hairs')
print("Air: 12-hair vs 25-hair")
print(model.air1225)
model.air1825<-t.test(alldataair.totalconc$'18hairs',alldataair.totalconc$'25hairs')
print("Air: 18-hair vs 25-hair")
print(model.air1825)
```
...
plot_grid(water.gap,  water.Re, water.angle, air.gap, air.Re,  air.angle,
          nrow = 2)
#dev.off()
#png(filename = "legend.png", height = 3, width=6, unit="in", res=600)
...
allrows.water<-ggplot(alldatarowwater.melted,aes(variable,value,fill=array)) + 
  #geom_violin() + 
  geom_jitter(size=2.5, color = "gray30", pch=21)+
  xlab("") + ylab("Conc captured per row")+ 
  scale_fill_viridis(discrete=TRUE)+theme_bw() + theme(legend.position = "right")
#leg.water <- get_legend(allrows.water)
#allrows.water<-ggplot(alldatarowwater.melted,aes(variable,value,fill=array)) + 
  #geom_violin() + 
#  geom_jitter(size=1.5, color = "gray30", pch=21)+
#  xlab("") + ylab("Conc captured per row")+ 
#  scale_fill_viridis(discrete=TRUE)+theme_bw() + theme(legend.position = "none")
...
allrows.air<-ggplot(alldatarowair.melted,aes(variable,value,fill=array)) + 
  ...
  scale_fill_viridis(discrete=TRUE, option="C")+theme_bw() + theme(legend.position = "right")
#leg.air <- get_legend(allrows.air)
#allrows.air<-ggplot(alldatarowair.melted,aes(variable,value,fill=array)) + 
  #geom_violin() + 
#  geom_jitter(size=1.5, color = "gray30", pch=21)+
#  xlab("") + ylab("Conc captured per row") + scale_x_discrete(position="top") +
#  scale_fill_viridis(discrete=TRUE, option="C")+theme_bw() + theme(legend.position = "none")

#png(file = "jiggerrow.png", height = 3.75, width = 9.4, unit = "in", res = 500)
plot_grid(allrows.water,allrows.air)
#dev.off()
#png(filename="legend.png", height = 4, width = 6, unit = "in", res = 600)
#plot_grid(leg.air,leg.water,nrow=2)
```
...
row1water <- ggplot(alldatarow.water, aes(angle, row1, fill = array)) +
  geom_point(size = 2.75, pch = 21, color = "gray30") + 
  scale_fill_viridis(name = "Array", discrete = TRUE) + 
