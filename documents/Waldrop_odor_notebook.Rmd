...
label.df <- data.frame(variable=c("3hairs","18hairs","25hairs"), value=c(30000,NA,NA))
...
all.air <- ggplot(alldataairconc.melted, aes(variable, value, fill = variable)) +
  ...
  geom_point(data=label.df,mapping=aes(x=variable,y=value),color="black",pch="*",size=6) +
