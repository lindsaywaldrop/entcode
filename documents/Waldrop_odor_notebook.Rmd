...
three_dat <- read.csv("./results/r-csv-files/3hair_results/totalconc_3hairs_2023-02-16_cleaned.csv", 
                      skip = 0, header = T, row.names = 1)
twofive_dat <- read.csv("./results/r-csv-files/25hair_results/totalconc_25hairs_2023-02-20_cleaned.csv", 
                        skip = 0, header = T, row.names = 1)
