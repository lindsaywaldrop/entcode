...
makehairs<-function(th,GtD,number){
  ...
  hair6Centerx = hair2Centerx+width*cos((30/180)*pi)
  hair6Centery = hair2Centery+width*sin((30/180)*pi)
  
  hair7Centerx = hair3Centerx+width*cos((30/180)*pi)
  hair7Centery = hair3Centery-width*sin((30/180)*pi)
  
  hair8Centerx = hair7Centerx+width*cos((30/180)*pi)
  hair8Centery = hair7Centery-width*sin((30/180)*pi)
