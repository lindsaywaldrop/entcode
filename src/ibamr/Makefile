...
SOURCES = main.C update_target_point_positions.C update_target_point_positions.h RigidBodyKinematics.cpp
OBJS = main.o update_target_point_positions.o RigidBodyKinematics.o
