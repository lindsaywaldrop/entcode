...
cut -f 2 lineout_h2-h3.txt > startx.txt
cut -f 3 lineout_h2-h3.txt > starty.txt
cut -f 4 lineout_h2-h3.txt > endx.txt
cut -f 5 lineout_h2-h3.txt > endy.txt

cut -f 6 lineout_h2-h3.txt > hair1x.txt
cut -f 7 lineout_h2-h3.txt > hair1y.txt
cut -f 8 lineout_h2-h3.txt > hair2x.txt
cut -f 9 lineout_h2-h3.txt > hair2y.txt
cut -f 10 lineout_h2-h3.txt > hair3x.txt
cut -f 11 lineout_h2-h3.txt > hair3y.txt
cut -f 12 lineout_h2-h3.txt > gapwidths.txt

# Count number of lines in files
numlines=$(grep -c "^" lineout_h2-h3.txt)
